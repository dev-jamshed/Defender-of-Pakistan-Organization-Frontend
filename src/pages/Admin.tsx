...
const cmsPageGroups = [
  ...
  { label: 'About', sections: ['about', 'about-story', 'about-beliefs', 'about-values', 'about-profile', 'about-trust', 'about-cta'] },
  { label: 'Action Plan', sections: ['action-plan', 'action-plan-overview', 'action-plan-detail', 'action-plan-statement', 'action-plan-cta'] },
  { label: 'Membership', sections: ['membership', 'membership-summary', 'membership-readiness', 'membership-card', 'membership-responsibility', 'membership-cta'] },
  { label: 'Designations', sections: ['designations', 'designations-metrics', 'designations-standard', 'designations-directory', 'designations-note', 'designations-cta'] },
  { label: 'Cards', sections: ['card-design', 'card-design-lab', 'card-design-principles', 'card-design-reference', 'card-design-cta'] },
...
function cmsEditorConfig(slug: string) {
  ...
  const configs: Record<string, typeof defaults> = {
    ...
    'about-story': {
      ...
      buttons: true,
      customFields: [
        { key: 'stampTop', label: 'Image Stamp Top' },
        { key: 'stampTitle', label: 'Image Stamp Title' },
        { key: 'stampText', label: 'Image Stamp Text' },
    ...
    'about-beliefs': {
      ...
      vision: 'Vision Text',
      customFields: [
        { key: 'missionTitle', label: 'Mission Label' },
        { key: 'visionTitle', label: 'Vision Label' },
      ],
    },
    'about-values': {
      ...defaults,
    ...
    'about-profile': {
      ...
      image: '',
      customFields: [
        { key: 'nameLabel', label: 'Official Name Label' },
        { key: 'shortNameLabel', label: 'Short Name Label' },
    ...
    'action-plan-overview': {
      ...
      customFields: [
        { key: 'quote', label: 'Quote Text', multiline: true },
        { key: 'imageCaption', label: 'Image Caption' },
      ],
    },
    'action-plan-detail': {
      ...defaults,
      ...
      text: 'Section Text',
      image: '',
      items: 'Priority Rows (Title | Text)',
      customFields: [
        { key: 'itemLabel', label: 'Item Label' },
        { key: 'itemFooter', label: 'Item Footer Text' },
      ],
    },
    ...
    'designations-standard': {
      ...
      items: 'Standard Points (one per line)',
      customFields: [{ key: 'imageCaption', label: 'Image Caption' }],
    },
    'designations-directory': {
      ...
      customFields: [
        ...
        { key: 'countLabel', label: 'Count Label' },
      ],
    },
    'designations-note': {
      ...defaults,
    ...
    'card-design-lab': {
      ...
      image: '',
      customFields: [
        { key: 'hint', label: 'Switch Hint' },
        { key: 'frontTitle', label: 'Front Box Title' },
        { key: 'frontItems', label: 'Front Box Items', multiline: true },
        { key: 'backTitle', label: 'Back Box Title' },
        { key: 'backItems', label: 'Back Box Items', multiline: true },
      ],
    },
    'card-design-principles': {
      ...
      text: 'Section Text',
      image: '',
      items: 'Principle Cards (Title | Text)',
    },
    'card-design-reference': {
      ...
      secondaryImage: 'Second Reference Image',
    },
    'card-design-cta': {
      ...defaults,
      title: 'CTA Title',
    ...
    'membership-summary': {
      ...
      customFields: [
        ...
        { key: 'memberValue', label: 'Member Value' },
        { key: 'feeLabel', label: 'Fee Label' },
        { key: 'feeValue', label: 'Fee Value' },
        { key: 'validityLabel', label: 'Validity Label' },
        { key: 'validityValue', label: 'Validity Value' },
        { key: 'documentsLabel', label: 'Documents Label' },
        { key: 'documentsValue', label: 'Documents Value' },
      ],
    },
    'membership-readiness': {
      ...
      text: 'Section Text',
      image: 'Background Image',
      items: 'Approval Steps (one per line)',
      buttons: true,
      customFields: [
        { key: 'documentsTitle', label: 'Documents Box Title' },
        { key: 'fieldsTitle', label: 'Information Box Title' },
        { key: 'formFields', label: 'Application Information Items', multiline: true },
        { key: 'panelEyebrow', label: 'Steps Panel Small Heading' },
        { key: 'panelTitle', label: 'Steps Panel Title' },
      ],
    },
    'membership-card': {
      ...defaults,
    ...
    'membership-responsibility': {
      ...
      text: 'Section Text',
      image: 'Background Image',
      items: 'Responsibility Points (one per line)',
    },
    'membership-cta': {
      ...defaults,
      title: 'CTA Title',
...
function cmsSectionLabel(page: DpoRecord) {
  const labels: Record<string, string> = {
    ...
    about: 'About Hero',
    'about-story': 'Story',
    'about-beliefs': 'Mission & Vision',
    'about-values': 'Core Values',
    'about-profile': 'Official Profile',
    'about-trust': 'Public Trust',
    'about-cta': 'Final CTA',
    'action-plan': 'Action Plan Hero',
    'action-plan-overview': 'Framework',
    'action-plan-detail': 'Priorities',
    'action-plan-statement': 'Statement',
    'action-plan-cta': 'Final CTA',
    membership: 'Membership Hero',
    'membership-summary': 'Summary Bar',
    'membership-readiness': 'Application Readiness',
    'membership-card': 'Card Identity',
    'membership-responsibility': 'Responsibility',
    'membership-cta': 'Final CTA',
    designations: 'Designations Hero',
    'designations-metrics': 'Metrics',
    'designations-standard': 'Leadership Standard',
    'designations-directory': 'Role Directory',
    'designations-note': 'Designation Notes',
    'designations-cta': 'Final CTA',
    'card-design': 'Card Hero',
    'card-design-lab': 'Interactive Preview',
    'card-design-principles': 'Design Principles',
    'card-design-reference': 'Reference Assets',
    'card-design-cta': 'Final CTA',
